...
O objetivo do projeto é transformar documentos não estruturados do mercado habitacional em dados relacionais rastreáveis, com foco inicial em PDFs de resultados, prévias operacionais e boletins de conjuntura.
...
Uma métrica só deve ser persistida se passar pelo contrato Pydantic. Para ser útil na camada de conjuntura, ela deve ter evidência rastreável: documento, página, trecho e confiança.
