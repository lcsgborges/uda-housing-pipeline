...
def upgrade() -> None:
    ...
    op.add_column("documents", sa.Column("classification_model", sa.String(length=120), nullable=True))
    op.add_column("documents", sa.Column("detected_domains", sa.JSON(), nullable=True))
    op.add_column("documents", sa.Column("extraction_strategy", sa.String(length=40), nullable=True))
